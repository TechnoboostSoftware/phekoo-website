    ...
    <nav className="fixed top-0 left-0 w-full z-[100] bg-white/90 backdrop-blur-md border-b border-gray-100 py-2 px-6 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-8">
          <a href="#how-to-play" className="hidden md:block text-phekoo-grey hover:text-phekoo-blue font-medium text-sm transition-colors">
            How to Play
          </a>
          <a href="#corporate-events" className="hidden md:block text-phekoo-grey hover:text-phekoo-blue font-medium text-sm transition-colors">
            Corporate Events
          </a>
